...
FLAGS = $(OPT_FLAG1) $(OPT_FLAG2) $(OPT_FLAG3) -D EZXML_NOMMAP
...
vprgp: $(OBJ) Makefile
	$(CC) -g -pg  $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
vprgc: $(OBJ) Makefile
	$(CC) -g -fprofile-arcs -ftest-coverage  $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
vprg: $(OBJ) Makefile
	$(CC) -g $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
vpro2: $(OBJ) Makefile
	$(CC) -O2 $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
vpro3: $(OBJ) Makefile
	$(CC) -O3 $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
vpros: $(OBJ) Makefile
	$(CC) -Os $(OBJ) -o $(EXE) $(LIB_DIR) $(LIB)
